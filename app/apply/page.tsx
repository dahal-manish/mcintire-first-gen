      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <Card className="bg-blue-gray mb-8">
          <CardHeader>
            ...
            <CardDescription className="text-blue-2 hidden">
              Follow these steps to apply for the McIntire First Generation
              Scholarship
            </CardDescription>
          </CardHeader>
          <CardContent className="text-blue-2">
            <ol className="list-decimal list-inside space-y-2">
              <li>
                Visit the UVA Alumni Association{" "}
                <a
                  href="https://uva-alumni-scholarships.awardspring.com/"
              ...
              <li>
                Look for the McIntire First Generation Scholarship in the list
                of available scholarships
              </li>
              <li>
                Answer any additional questions specific to our scholarship
              </li>
              <li>
                Upload required documents (e.g., transcripts, essays, letters of
                recommendation)
              </li>
        ...
        <Card className="bg-blue-gray mb-8 shadow-md">
          ...
          <CardContent className="text-blue-2">
            ...
            <div className="flex items-center mb-4">
              <Calendar className="mr-2 h-5 w-5 text-blue-3" />
              <p>Application Deadline: March 23, 2025</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-blue-gray shadow-md">
          ...
          <CardContent>
            ...
            <p className="mt-4 text-sm text-blue-2 italic">
              Note: You will be redirected to the UVA Alumni Association
              AwardSpring website to complete your application.
            </p>
          </CardContent>
        </Card>
