    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <div className="bg-blue-1 p-6 rounded-lg h-96 w-72 shadow-md flex flex-col justify-around cursor-pointer duration-300 hover:scale-[1.02] transition-ease-in-out">
